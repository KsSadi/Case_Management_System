...
@endif
                    ...
                    <div class="side-menu__title"> Case History </div>
                </a>
            </li>
        @endif
                ...
                <ul class="">
                    @if (Auth::guard('admin')->user()->can('report.month'))
                        <li>
                            <a href="{{ route('dashboard.reports.month') }}" class="side-menu">
                                ...
                                </div><div class="side-menu__title">Monthly Report</div>
                            </a>
                        </li>
                    @endif
                    ...
                    <li>
                        <a href="{{ route('dashboard.reports.date.index') }}" class="side-menu">
                            ...
                            <div class="side-menu__title"> Date Range Report </div>
                        </a>
                    </li>
                        @endif
...
@endif
                    ...
                    <div class="side-menu__title"> Case Item </div>
                </a>
            </li>
        @endif
        ...
        <li>
            <a href="javascript:;" class="side-menu
                                        @if (Request::is('dashboard/supreme-court*'))
                side-menu--active
            @endif
                ">
                <div class="side-menu__icon">
                ...
                <div class="side-menu__title"> Supreme Court <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
            </a>
            <ul class="">
                <li>
                    <a href="{{ route('dashboard.supreme-court.high-court.index') }}" class="side-menu">
                        <div class="side-menu__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                        </div>
                        <div class="side-menu__title">High Court Division</div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('dashboard.supreme-court.appellate.index') }}" class="side-menu">
                        <div class="side-menu__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                        </div>
                        <div class="side-menu__title">Appellate Division</div>
                    </a>
                </li>
...
@endif
                    ...
                    <div class="side-menu__title"> Case Type </div>
                </a>
            </li>
        @endif
        <li class=""></li>
...
@endif
                    ...
                    <div class="side-menu__title"> Case Division </div>
                </a>
            </li>
        @endif
...
@endif
                    ...
                    <div class="side-menu__title"> Court Name </div>
                </a>
            </li>
        @endif
...
@endif
                    ...
                    <div class="side-menu__title"> Advocate </div>
                </a>
            </li>
        @endif
        @if (Auth::guard('admin')->user()->can('company.view'))
            <li>
                <a href="{{ route('dashboard.companies.index') }}" class="side-menu
                                            @if (Request::is('dashboard/companies*'))
                    side-menu--active
@endif
                    ">
        ...
        <li>
            <a href="{{ route('dashboard.important-links.index') }}" class="side-menu
                                        @if (Request::is('dashboard/important-links*'))
                side-menu--active
            @endif
                ">
                <div class="side-menu__icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></div>
                <div class="side-menu__title"> Important Link </div>
            </a>
        </li>
        <div class="side-nav__devider my-6"></div>

{{--        Case PArt Ended--}}
{{--        Roles Menu Commented Out--}}
