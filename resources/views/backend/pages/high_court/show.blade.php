    ...
    <div class="intro-y box mt-5">
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
            ...
            <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                <a href="{{ route('dashboard.supreme-court.high-court.index') }}" class="button bg-gray-200 text-gray-700 mr-2 flex items-center">
                    Back to List
                </a>
                <a href="{{ route('dashboard.supreme-court.high-court.edit', $case->id) }}" class="button text-white bg-theme-1 shadow-md flex items-center">
                    Edit Case
                </a>
            </div>
        </div>
