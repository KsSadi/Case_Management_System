    ...
    <div class="intro-y datatable-wrapper box p-5 mt-5" id="print-section">
        ...
        <div id="print-header" style="display:none;">
            <div style="text-align:center; border-bottom: 2px solid #333; padding-bottom: 12px; margin-bottom: 14px;">
                <h1 style="font-size: 20px; font-weight: bold; margin: 0 0 4px 0;">মামলার তালিকা (High Court Division)</h1>
                <h2 style="font-size: 14px; font-weight: normal; color: #444; margin: 0 0 6px 0;">High Court Division Cases Report</h2>
        ...
        <div class="flex justify-end mb-3 no-print">
            <button onclick="printHighCourtTable()" class="button flex items-center bg-gray-700 text-white">
            ...
            <table class="table table-report table-report--bordered display datatable w-full" id="result-table">
                ...
                @foreach($cases as $case)
                    <tr>
                        ...
                        <td>
                            <a class="flex items-center mr-3 text-theme-1 no-print" href="{{ route('dashboard.supreme-court.high-court.show', $case->id) }}">
                        ...
                        <td class="table-report__action w-56 no-print">
                            <div class="flex justify-center items-center">
                                ...
                                <form id="delete-form-{{$case->id}}" action="{{ route('dashboard.supreme-court.high-court.destroy', $case->id) }}" method="POST" style="display: none">
                                    @method('DELETE')
                                    @csrf
                                </form>
                                @endif
