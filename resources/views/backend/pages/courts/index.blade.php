    ...
    <table class="table table-report -mt-2">
        <thead>
            <tr>
                ...
                @if (Auth::guard('admin')->user()->can('court.edit') || Auth::guard('admin')->user()->can('court.delete'))
            ...
            <tr class="intro-x">
                ...
                <td class="table-report__action w-56">
                    <div class="flex justify-center items-center">
                        @if (Auth::guard('admin')->user()->can('court.edit'))
                        ...
                        @if (Auth::guard('admin')->user()->can('court.delete'))
