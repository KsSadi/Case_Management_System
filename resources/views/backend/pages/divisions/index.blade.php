...
@section('admin-section')
    ...
    <table class="table table-report -mt-2">
        ...
        <tr>
            ...
            @if (Auth::guard('admin')->user()->can('division.edit') || Auth::guard('admin')->user()->can('division.delete'))
            ...
            <tr class="intro-x">
                ...
                <td class="table-report__action w-56">
                    <div class="flex justify-center items-center">
                        @if (Auth::guard('admin')->user()->can('division.edit'))
                        ...
                        @if (Auth::guard('admin')->user()->can('division.delete'))
